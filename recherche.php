...
<!--[if (gte IE 9)|!(IE)]><!--> <html class="not-ie no-js" lang="en">  <!--<![endif]-->
    <head>
        ...
        <!-- Basic Page Needs -->
        <meta charset="utf-8">
        <title>Fi thniti ? - Recherche</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="page-content">
							...
							$timedate=$_SESSION["timedate"];
							$places=$_SESSION["places"];
							$res=mysqli_query($c,"select * from annonce where depart='".$departure."' && arrivee='".$arrival."' && date='".$timedate."' && nbplaces='".$places."'");
